          ...
          child: RichText(
            text: TextSpan(
              children: <TextSpan>[
                ...
                TextSpan(
                  text:
                      " - это приложение для людей, которым важно как и быть в курсе последних новостей из социальных сетей, так и использовать своё время с пользой.",
          ...
          onPageFinished: (String url) async {
            ...
            if (url.startsWith("https://oauth.vk.com/blank.html")) {
              ...
              Navigator.pushReplacement(context,
                  MaterialPageRoute(builder: (context) => ScreenLimits()));
            }
          },
        ),
        Center(
